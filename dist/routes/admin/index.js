...
var adminAuth_1 = __importDefault(require("./adminAuth"));
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma.adminUser
                        ...
                        .then(function (res) { return res === null || res === void 0 ? void 0 : res.latest_login; })["catch"](function (e) {
                        console.log(e);
                        res.sendStatus(500);
                        return false;
                    })];
...
router.use("/videos", isAuth, videos_1["default"]);
