    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                key = req.body.key;
                if (!(!username || !key)) return [3 /*break*/, 1];
                res.sendStatus(400);
                return [3 /*break*/, 4];
            case 1:
                if (!(key.replace(/\s/g, "") !== process.env.RESET_ACCOUNT_SECRET)) return [3 /*break*/, 2];
                console.log("Specified was " +
                    key.replace(/\s/g, "") +
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, prisma.adminUser.findFirst({
                    select: {
                        username: true
                    },
                    where: {
